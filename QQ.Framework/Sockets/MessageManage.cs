...
namespace QQ.Framework.Sockets
{
    ...
    {
        private readonly QQClient client;
        ...
        private void Receive(object state)
        {
            while (true)
            {
                ...
                var receive_command = DispatchPacketToCommand.of(tempBuf, client)
            ...
            while (true)
            {
                ...
                switch (_ReceivePacket.Command)
                {
                    case QQCommand.Login0x0825:
                        ...
                        var _0825e = new QQEventArgs<Receive_0x0825>(client, _0825Packet);
                    ...
                    case QQCommand.Login0x0836:
                        ...
                        var _0836e = new QQEventArgs<Receive_0x0836>(client, _0836Packet);
                    ...
                    case QQCommand.Login0x0828:
                        ...
                        var _0828e = new QQEventArgs<Receive_0x0828>(client, _0828Packet);
